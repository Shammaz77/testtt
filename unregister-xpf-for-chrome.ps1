...
Remove-Item -Path "HKLM:\Software\Classes\.xpf" -Recurse -Force -ErrorAction SilentlyContinue
Remove-Item -Path "HKLM:\Software\Classes\SheetXPFFile" -Recurse -Force -ErrorAction SilentlyContinue
